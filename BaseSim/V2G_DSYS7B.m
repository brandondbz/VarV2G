...
mpc.bus = [ %% (Pd and Qd are specified in kW & kVAr here, converted to MW & MVAr below)
	...
	3	1	200	600	0	0	1	1	0	12.66	1	1.1	0.9;
	4	1	200	100	0	0	1	1	0	12.66	1	1.1	0.9;
	5	1	200	100	0	0	1	1	0	12.66	1	1.1	0.9;
	6	1	420	200	0	0	1	1	0	12.66	1	1.1	0.9;
	7	1	420	200	0	0	1	1	0	12.66	1	1.1	0.9;
];
...
mpc.branch = [  %% (r and x specified in ohms here, converted to p.u. below)
	1	2	0.5416	0.7129	0	0	0	0	0	0	1	-360	360;
	2	3	0.4930	0.2511	0	0	0	0	0	0	1	-360	360;
  3	4	1.4680	1.1550	0	0	0	0	0	0	1	-360	360;
	4	5	2.0000	2.0000	0	0	0	0	0	0	0	-360	360;
